...
if __name__ == "__main__":
    ...
    #FrozenTrial(number=449, value=0.419474, datetime_start=datetime.datetime(2021, 2, 11, 10, 33, 54), datetime_complete=datetime.datetime(2021, 2, 11, 11, 10), params={'activation_dec': 'relu', 'activation_ode': 'tanh', 'activation_rnn': 'none', 'batchsize': 0.276469, 'dropout_dec': 0.173605, 'enctype': 'RNN', 'latent_dim': 2.69398, 'lr': 0.00715729, 'nhidden': 0.515954, 'num_odelayers': 3, 'rnn_nhidden_dec': 0.400573, 'rnn_nhidden_enc': 0.00971514, 'scaling_ELBO': 1.19349, 's_dim_static': 6, 'z_dim_static': 2}
    nepochs = 1480
    activation_dec = 'relu'
    activation_ode = 'tanh'
    activation_rnn = 'none'
    batchsize = (0.276469*750)/1000
    dropout_dec = 0.173605
    enctype = 'RNN'
    latent_dim = 2.69398
    lr = 0.00715729
    nhidden = 0.515954
    num_odelayers = 3
    rnn_nhidden_dec = 0.400573
    rnn_nhidden_enc = 0.00971514
    scaling_ELBO = 1.19349
    s_dim_static = 6
    z_dim_static = 2
    ...
    torch.save({'Recon_values': xs_pos_rec,
                ...
                'W_train': W_train}
               ,train_dir + '/Reconstruction_n3000_eps005_t100_normed.pth')
    ...
    torch.save({'Generation_values': xs_pos_posterior,
                ...
                'varnamesstatic':varnamesstatic}
               ,train_dir + '/Generationposterior_n3000_eps005_t100_normed.pth')
