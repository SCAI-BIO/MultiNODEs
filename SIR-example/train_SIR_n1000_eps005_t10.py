...
if __name__ == "__main__":
    ...
    #FrozenTrial(number=635, value=0.0420082, datetime_start=datetime.datetime(2021, 2, 11, 10, 34, 5), datetime_complete=datetime.datetime(2021, 2, 11, 10, 41, 53), params={'activation_dec': 'tanh', 'activation_ode': 'none', 'activation_rnn': 'tanh', 'batchsize': 0.367031, 'dropout_dec': 0.00180114, 'enctype': 'RNN', 'latent_dim': 1.04597, 'lr': 0.00678686, 'nhidden': 3.79528, 'num_odelayers': 5, 'rnn_nhidden_dec': 0.910399, 'rnn_nhidden_enc': 0.436512, 'scaling_ELBO': 1.3888, 's_dim_static': 2, 'z_dim_static': 6}
    nepochs =676
    activation_dec = 'tanh'
    activation_ode = 'none'
    activation_rnn = 'tanh'
    batchsize = (0.367031*750)/1000
    dropout_dec = 0.00180114
    enctype = 'RNN'
    latent_dim = 1.04597
    lr = 0.00678686
    nhidden = 3.79528
    num_odelayers = 5
    rnn_nhidden_dec = 0.910399
    rnn_nhidden_enc = 0.436512
    scaling_ELBO = 1.3888
    s_dim_static = 2
    z_dim_static = 6
    ...
    torch.save({'Recon_values': xs_pos_rec,
                ...
                'W_train': W_train}
               ,train_dir + '/Reconstruction_n3000_eps005_t10_normed.pth')
    ...
    torch.save({'Generation_values': xs_pos_posterior,
                ...
                'varnamesstatic':varnamesstatic}
               ,train_dir + '/Generationposterior_n3000_eps005_t10_normed.pth')
