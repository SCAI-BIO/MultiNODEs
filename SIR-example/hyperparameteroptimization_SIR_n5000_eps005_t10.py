...
def time_objective(trial):
    ...
    train = np.asarray(samp_trajs[:3750,:,:])
    val = np.asarray(samp_trajs[3750:,:,:])
    
    train_wei = np.asarray(W_train[:3750,:,:])
    val_wei = np.asarray(W_train[3750:,:,:])
    
    static_train = np.asarray(static[:3750,:])
    static_test = np.asarray(static[3750:,:])
    
    staticdata_onehot_train = np.asarray(staticdata_onehot[:3750,:])
    staticdata_onehot_test = np.asarray(staticdata_onehot[3750:,:])
    
    static_true_miss_mask_train = np.asarray(static_true_miss_mask[:3750,:])
    static_true_miss_mask_test = np.asarray(static_true_miss_mask[3750:,:])
