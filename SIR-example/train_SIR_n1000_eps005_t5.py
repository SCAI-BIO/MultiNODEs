...
if __name__ == "__main__":
    ...
    #FrozenTrial(number=872, value=0.0201486, datetime_start=datetime.datetime(2021, 2, 17, 9, 56, 24), datetime_complete=datetime.datetime(2021, 2, 17, 10, 0, 4), params={'activation_dec': 'tanh', 'activation_ode': 'none', 'activation_rnn': 'tanh', 'batchsize': 0.683492, 'dropout_dec': 0.00545472, 'enctype': 'RNN', 'latent_dim': 0.479475, 'lr': 0.00828768, 'nhidden': 0.812782, 'num_odelayers': 5, 'rnn_nhidden_dec': 0.857999, 'rnn_nhidden_enc': 0.649597, 'scaling_ELBO': 0.633321, 's_dim_static': 2, 'z_dim_static': 4}
    nepochs=546
    activation_dec = 'tanh'
    activation_ode = 'none'
    activation_rnn = 'tanh'
    batchsize = (0.683492*750)/1000
    dropout_dec = 0.00545472
    enctype = 'RNN'
    latent_dim = 0.479475
    lr = 0.00828768
    nhidden = 0.812782
    num_odelayers = 5
    rnn_nhidden_dec = 0.857999
    rnn_nhidden_enc = 0.649597
    scaling_ELBO = 0.633321
    s_dim_static = 2
    z_dim_static = 4
    ...
    torch.save({'Recon_values': xs_pos_rec,
                ...
                'W_train': W_train}
               ,train_dir + '/Reconstruction_n3000_eps005_t5_normed.pth')
    ...
    torch.save({'Generation_values': xs_pos_posterior,
                ...
                'varnamesstatic':varnamesstatic}
               ,train_dir + '/Generationposterior_n3000_eps005_t5_normed.pth')
